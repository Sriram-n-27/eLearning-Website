...
?>
       ...
       <span style="font-size:30px">PYTHON and got <?php print $var; ?> %</span> <br/><br/><br><br><br><br>
...
if ( $result->num_rows > 0 ) {
   $sql= "UPDATE marks set PYTHON='$var' WHERE Name='$fn' and lname='$ln'";
    $query=mysqli_query($mysqli,$sql);
            if($query)
                echo 'data updated';
            }
else {
$sql= "INSERT INTO marks (Name,lname,PYTHON) "
    ." VALUES ('$fn','$ln','$var')";
$query=mysqli_query($mysqli,$sql);
            if($query)
                echo 'data inserted';
