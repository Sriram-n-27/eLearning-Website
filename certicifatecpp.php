...
?>
       ...
       <span style="font-size:30px">C++ and got <?php print $var; ?> %</span> <br/><br/><br><br><br><br>
...
if ( $result->num_rows > 0 ) {
   $sql= "UPDATE marks set CPP='$var' WHERE Name='$fn' and lname='$ln'";
    $query=mysqli_query($mysqli,$sql);
            if($query)
                echo 'data updated';
            }
else {
$sql= "INSERT INTO marks (Name,lname,CPP) "
    ." VALUES ('$fn','$ln','$var')";
$query=mysqli_query($mysqli,$sql);
            if($query)
                echo 'data inserted';
